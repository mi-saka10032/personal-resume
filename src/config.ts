...
const workInfo: Work[] = [
  ...
  },
  {
    ...
    desc: [
      ...
      `参与多个管理系统（中台管理系统、物流管理系统、钢铁产能系统）的子菜单页面开发，完成产能资源、会员中心相关列表的CRUD、文件上传等功能，采用技术均为：Vue2+VueRouter+VueX+ElementUI`,
      `针对「公司总部」提供的前端组件库文档内容描述与功能演示不完整的地方，重写了一份组件库文档<mark>(Vue+Markdown)</mark>，为成都公司的同事提供便利`,
    ],
  },
];
